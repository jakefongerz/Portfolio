...
public class HashingPoetry {
    public static void main(String[] args) {
        ...
        System.out.println(poem.writePoem("green.txt", "you", 25, true));
        System.out.println();

        System.out.println("--- Lester ---");
        System.out.println(poem.writePoem("lester.txt", "lester", 25, false));
        System.out.println();

        System.out.println("--- How Many ---");
        System.out.println(poem.writePoem("how-many.txt", "how", 20, false));
        System.out.println();
